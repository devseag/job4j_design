...
public class Menu {
    ...
    public static final String BEGIN = " Nachalo sortirovki - ";

    public static final String END = " Konec sortirovki - ";

    public static final String SELECT = "Vvedite kolichestvo jelementov";

    public static final String ARRAY_INFO = "Massiv sozdan i zapolnen sluchajnymi znachenijami ot 1 do ";

    public static final String MENU = """
                Vvedite 1 dlja sozdanie massiva.
                Vvedite 2, chtoby nachat' sortirovku slijaniem.
                Vvedite 3, chtoby nachat' sortirovku puzyr'kom.
                Vvedite 4,chtoby nachat' sortirovku vstavkami.
                Vvedite ljuboe drugoe chislo dlja vyhoda.
            """;
    ...
    public static void main(String[] args) {
        ...
        while (run) {
            ...
            if (CREATE_ARRAY == userChoice) {
                ...
                run = false;
                System.out.println("Konec raboty");
            }
        }
    }
}
...
//-XX:+UseZGC -Xmx20m -Xms20m -Xlog:gc:log.txt